...
def create_quadruped_skeleton():
    ...
    spine_root = create_joint("spine_root_JNT", (0, 2.5, -0.8), parent=master_ctrl)
    spine_mid = create_joint("spine_mid_JNT", (0, 2.2, 0.4), spine_root)
    spine_top = create_joint("spine_top_JNT", (0, 2.3, 1.1), spine_mid)
    neck = create_joint("neck_JNT", (0, 2.5, 1.5), spine_top)
    head = create_joint("head_JNT", (0, 2.5, 2), neck)
    
    tail_01 = create_joint("tail_01_JNT", (0, 2.6, -1.4), spine_root)
    tail_02 = create_joint("tail_02_JNT", (0, 2.9, -1.7), tail_01)
    tail_03 = create_joint("tail_03_JNT", (0, 3.3, -1.83), tail_02)
    tail_04 = create_joint("tail_04_JNT", (0, 3.8, -1.73), tail_03)

    shoulder_L = create_joint("shoulder_L_JNT", (0.4, 1.8, 1), spine_top)
    elbow_L = create_joint("elbow_L_JNT", (0.5, 0.9, 0.9), shoulder_L)
    paw_L = create_joint("paw_L_JNT", (0.5, 0.2, 0.9), elbow_L)

    hip_L = create_joint("hip_L_JNT", (0.4, 2, -0.5), spine_root)
    knee_L = create_joint("knee_L_JNT", (0.4, 1.15, -0.77), hip_L)
    pawBack_L = create_joint("pawBack_L_JNT", (0.4, 0.1, -0.9), knee_L)
